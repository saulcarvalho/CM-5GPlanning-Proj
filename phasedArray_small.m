...
azvec = -180:180;
elvec = -90:90;
Am = 60;    % Atenuação Máxima (dB)                 <- (default = 30) Aumentar este valor reduz o lóbulo principal da cauda
tilt = 0;   % Ângulo de Inclinação
az3dB = 35; % 3 dB de largura de banda em azimute   <- (default = 65) Baixar estes 2 valores faz com que a antena fique mais diretiva, concentra a radiação
el3dB = 35; % 3 dB de largura de banda em elevação
...
% Define array size 
nrow = 6;                   % <- (default = 8) Diminuir o número de elementos do array faz com que o lóbulo principal expanda e reduz o número de lóbulos secundários
ncol = 6;                   % <- aumentar este valor aumenta o ganho, torna o array mais diretivo e aumenta o número de lóbulos secundários
